...
use crate::sudoku::{self, Tile, Direction};
    ...
    pub fn update_gui(&mut self, update: Update) {
        ...
        egui::Window::new("Settings").show(&ctx, |ui| {
            ...
            if ui.checkbox(&mut self.sudoku.running, "Running").clicked() {
                ...
                self.sudoku.tiles = self.sudoku.tiles.iter().map(|t| match t {
            ...
            if !self.sudoku.solve_instantly {
                ...
                ui.add(egui::Slider::new(&mut self.sudoku.steps_per_frame, 1..=100000).logarithmic(true));
            }
            ui.label("Clear");
